...
def get_eth_balance(pub_key, priv_key):
    ...
    return 0.0  # No ETH balance found

def _sellEthereum(sell_size_usd, pub_key, priv_key):
    base_url = "https://api.gemini.com"

    # Check ETH balance first
    eth_balance = get_eth_balance(pub_key, priv_key)
    print(f"ETH Available Balance: {eth_balance}")

    # Get current bid price from public ticker
    ...
    eth_amount = round((sell_size_usd * 0.998) / execution_price, tick_size)
